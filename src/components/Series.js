...
const Series = () => {
  ...
  const IMG_PATH = 'https://image.tmdb.org/t/p/w1280'
    ...
    useEffect(() =>{
        getMovies('https://api.themoviedb.org/3/discover/tv?api_key=3fd2be6f0c70a2a598f084ddfb75487c&language=en-US&sort_by=popularity.desc&page=1&timezone=America%2FNew_York&include_null_first_air_dates=false&with_watch_monetization_types=flatrate');
    ...
    return ( 
      <>
       <Helmet>
        ...
        <Container>
          <div className="titulo1" ><h1 >Series</h1></div>
